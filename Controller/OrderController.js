...
function loadItemCodes(){
    $.ajax({
        url: "http://localhost:8080/POS_BackEnd/item?function=getAll",
        method: "get",
        dataType: "json",
...
$("#cusIdOption").on("change",function (){
    ...
    $.ajax({
        url: "http://localhost:8080/POS_BackEnd/customer?function=getById&id="+selectedOption,
        method: "get",
        dataType: "json",
        success: function (resp, textStatus, jqXHR){
            console.log(resp);
...
function o_findItem(id, callback){
    $.ajax({
        url: "http://localhost:8080/POS_BackEnd/item?function=getById&id="+id,
        method: "get",
        dataType: "json",
        success: function (resp, textStatus, jqXHR){
            console.log(resp);
...
function generateNextOrderID() {
    $.ajax({
        url: "http://localhost:808/POS_BackEnd/order?function=getLastId",
        method: "get",
        success: function (resp, textStatus, jqxhr) {
            console.log(resp);
        ...
        if($("#orderCart tr").length==0){
            ...
            if(discount>=0 && discount<=100){
                if($("#orderCart").val()==""){
                    ...
                    $.ajax({
                        url: "http://localhost:8080/POS_BackEnd/order",
                        method: "post",
